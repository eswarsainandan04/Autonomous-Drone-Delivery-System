            ...
            with conn.cursor() as cur:
                cur.execute("""
                    SELECT id, drone_id, drone_name, model, drone_type,
                           ...
                           communication_key, source_lat, source_lng, dest_lat, dest_lng,
                ...
                with conn.cursor() as cur:
                    ...
                    sql = """
                        INSERT INTO dronesdata (
                            ...
                            camera_key, communication_key, source_lat, source_lng, dest_lat, dest_lng, status
                        )
                        VALUES (%s, %s, %s, %s, %s, %s, %s, %s, NULL, NULL, NULL, %s, %s, NULL, NULL, NULL, NULL, %s)
                        RETURNING id
                    """
                    cur.execute(sql, (
                ...
                with conn.cursor() as cur:
                    ...
                    sql = """
                        ...
                        SET drone_id = %s, drone_name = %s, model = %s, drone_type = %s,
                            ...
                            camera_key = %s, communication_key = %s, source_lat = NULL, source_lng = NULL,
                            dest_lat = NULL, dest_lng = NULL, updated_at = CURRENT_TIMESTAMP
